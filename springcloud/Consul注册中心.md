...
Consul Config 结合 Git 来做版本控制



# 二、consul 的可靠性

Consul 的 raft 协议要求必须过半数的节点都写入成功才认为注册成功 。当Leader 挂掉时，重新选举期间整个 Consul 不可用。保证了强一致性但牺牲了可用性
...
![img](http://www.mooooc.com/assets/images/2018/springcloud/consul-server-client.png)

**Consul 工作原理：**

![img](http://www.mooooc.com/assets/images/2018/springcloud/consol_service.png)
...
![img](http://www.mooooc.com/assets/images/2018/springcloud/consul_insall.png)

我这里以 Windows 为例，下载下来是一个 consul_1.2.1_windows_amd64.zip 的压缩包，解压是是一个 consul.exe 的执行文件。

![img](http://www.mooooc.com/assets/images/2018/springcloud/consul_win.png)
...
![img](http://www.mooooc.com/assets/images/2018/springcloud/consol_cmd.png)

启动成功之后访问：`http://localhost:8500`，可以看到 Consul 的管理界面

![img](http://www.mooooc.com/assets/images/2018/springcloud/consol_manage.png)
...
![img](http://www.mooooc.com/assets/images/2018/springcloud/consol_producer.png)

我们发现页面多了 service-producer 服务，点击进去后页面显示有两个服务提供者：

![img](http://www.mooooc.com/assets/images/2018/springcloud/consol_producer-2.png)
...
# 四、Spring Cloud自动推送配置到Consul配置中心

`Consul`是一个集配置管理、服务注册和发现于一体的微服务基础组件
